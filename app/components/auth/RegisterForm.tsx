  ...
  return (
    <div className="w-full max-w-md p-8 space-y-8 bg-white rounded-xl shadow-md">
      <div className="text-center">
        <h1 className="text-2xl font-bold">Create your ZappForm account</h1>
        <p className="mt-2 text-gray-600">
          Start filling forms instantly with AI-powered autofill
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="mt-8 space-y-6">
        <div>
          ...
          <input
            ...
            className={`w-full px-3 py-2 mt-1 text-gray-900 placeholder-gray-400 border ${
